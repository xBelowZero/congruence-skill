...
When you are about to declare work complete, commit, open a PR, update README/CHANGELOG/docs, or ship any change affecting user-facing text, audit whether your claims match the code.
