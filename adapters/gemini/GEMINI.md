...
Audits whether what the agent said, wrote, or documented matches what the code actually does. **Not technical code review** — checks whether claims about the code are true.
...
You can also import additional files: `@references/claim-extraction-guide.md`.
