# Congruence — Code conventions

This file is read by Aider via `.aider.conf.yml` (`read: CONVENTIONS.md`) and marked read-only. It enforces semantic congruence between your claims and the code.
