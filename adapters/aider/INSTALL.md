...
```bash
cd your-project/
curl -L https://raw.githubusercontent.com/brunnocarpena/congruence-skill/main/adapters/aider/CONVENTIONS.md -o CONVENTIONS.md
```
...
- **No Task tool** — to dispatch an independent auditor, open a new Aider session in a different terminal and paste [auditor-prompt](https://github.com/brunnocarpena/congruence-skill/blob/main/auditor-prompt.md).
